...
main(int argc, char* argv[])
{
    ...
    double centralFrequency = 3.410e9;
    double bandwidth = 34.56e6;
    ...
    gridScenario.SetColumns(4);
    gridScenario.SetHorizontalBsDistance(500.0);
    gridScenario.SetVerticalBsDistance(333.3333);
    ...
    gridScenario.SetScenarioHeight(1000); // Create a 1000x1000 scenario where the UE will
