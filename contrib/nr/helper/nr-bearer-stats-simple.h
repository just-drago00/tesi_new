...
public:
   ...
   */
  virtual void UlRxPdu (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint8_t lcid, uint32_t packetSize, uint64_t delay, uint16_t txRnti) = 0;
  /**
   ...
   * @param delay RLC to RLC delay in nanoseconds
   */
  virtual void DlRxPdu (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint8_t lcid, uint32_t packetSize, uint64_t delay, uint16_t txRnti) = 0;
  ...
  virtual void UeRlcBufferSizeSl (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint32_t srcLcId, uint32_t destLcId, uint32_t rlcBufferSize, uint32_t rlcMaxBufferSize) = 0;
  // end modification
};
...
public:
   ...
   * @param delay RLC to RLC delay in nanoseconds
   */
  virtual void UlRxPdu (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint8_t lcid, uint32_t packetSize, uint64_t delay, uint16_t txRnti) override;
   ...
   * @param delay RLC to RLC delay in nanoseconds
   */
  virtual void DlRxPdu (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint8_t lcid, uint32_t packetSize, uint64_t delay, uint16_t txRnti) override;
  ...
  virtual void UeRlcBufferSizeSl (uint16_t cellId, uint64_t imsi, uint16_t rnti, uint32_t srcLcId, uint32_t destLcId, uint32_t rlcBufferSize, uint32_t rlcMaxBufferSize) override;
